...
#define PROGNAME "LPT_IO    written by Duncan Murray.   (c) Acute Software 1999"
#define PROGDESC "Program to control the output bits of a printer port"
#include "USER_IF.HH"
#include "PCIO_SCN.HH"
...
int valueAnalog[4];
int valueAnalogMin[4];
int valueAnalogMax[4];

int gotoHiResMode(void);
void DrawOscilliscopeScreen(int,int,int,int,int,int);
void StorageOscilliscope(char*,int,int,int,int,int,int);
...
void FastAcquisition(char[], char[]);
